...
namespace ManagedUPnP.Descriptions
{
    ...
    public static class ServiceExtensions
    {
        ...
        /// <returns>A DeviceServiceDescription.</returns>
        public static DeviceServiceDescription DeviceServiceDescription(this Service service, bool useCache = true)
        {
            return service.COMService.DeviceServiceDescription(service.COMDevice, service.Device.RootDeviceDescription(useCache));
        }
